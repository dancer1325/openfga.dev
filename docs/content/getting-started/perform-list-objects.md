...
* goal
  * how to perform a list objects request

* List Objects API 
  * allows you to
    * retrieve ALL objects of a specified type / a user has a given relationship with
  * uses
    * display ALL documents / user can read
    * list resources / user can manage
